...
class AdagaProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.skillq.setOnClickListener {
            ...
            binding.skilldescription.text = "Jogue uma faca que danos e retarda um inimigo. Cada hit adicional adiciona um pilha e atualiza a duração do debuff, fazendo com que o dano aumente por pilha."
        ...
        binding.skille.setOnClickListener {
            ...
            binding.skilldescription.text = "Executar um avance, danificando inimigos ao longo do caminho. Desbloqueio Final: Enquanto a raiva está cheia um eco de Shiv refaz o caminho do traço após um curto atraso, danificando os inimigos novamente"
            ...
            binding.skillleveldetailthree.text = "Reduza o tempo de recarga em 2s por inimigo atingido (1s para não-Herói). Máximo 6s por Dash"
        }
        binding.skillc.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Bloodletting "
            binding.skilldescription.text = "Pegue apenas uma parte do dano recebido imediatamente e adie o restante para ser tomado ao longo do tempo. Ativar para limpar uma parte do dano diferido."
        ...
        binding.skillx.setOnClickListener {
            ...
            binding.skilldescription.text = "Ative para saltar em direção a um herói inimigo e matar instantaneamente eles se a sua saúde é abaixo do limiar de mortecaso contrário, cause 200 de dano a eles.\nPassivo: Danificar inimigos enche você de raiva. Enquanto na rave completa, Shiv ganha dano aumentado e propriedades especiais sobre suas outras habilidades."
            ...
            binding.skilldetailthree.text = "Na"
            binding.skillleveldetail.text = "Ganhe +2m/s velocidade de movimento enquanto estiver com raiva total"
            binding.skillleveldetailtwo.text = "+8% Limiar de saúde do inimigo e +10% Dano de Bónus de Fúria Total"
            binding.skillleveldetailthree.text = "Terminar um inimigo com Killing Blow redefine sua recarga"
        }
