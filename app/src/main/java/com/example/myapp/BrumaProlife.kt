...
class BrumaProlife : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.skillq.setOnClickListener {
            ...
            binding.skilldescription.text = "Jogue uma adaga que danos e dorme o alvo. Os alvos adormecidos acordam logo após serem danificados. Jogar uma adaga não quebra sua invisibilidade. A Adaga do Sono não interrompe as habilidades de canalização dos inimigos"
            ...
            binding.skillleveldetailthree.text = "Aplica-se - 12% Bullet Resist para 6s no despertar"
        }
        binding.skille.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Smoke Bomb"
            binding.skilldescription.text = "Desvanecer-se da vista, tornando-se invisível e ganhando velocidade de sprint. Atacar remove a invisibilidade. Inimigos próximos podem ver através de sua invisibilidade"
            ...
            binding.skillleveldetailthree.text = "Depois de invis, ganhe +30% Bullet Lifesteal por 8s"
        }
        binding.skillc.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Fixation "
            binding.skilldescription.text = "Atirando um alvo aumenta o dano da bala naquele alvo. Ganhar um pilha por bala atingida, duas se a batida for um tiro na cabeça"
            ...
            binding.skillleveldetail.text = "60 Dano de espírito e 15% lento para 2s para atingir cada 20 pilhas"
        ...
        binding.skillx.setOnClickListener {
            ...
            binding.skilldescription.text = "Entre em uma enxurrada, disparando sua arma em inimigos próximos com precisão perfeita. Durante a agitação, Haze ganha um bônus de taxa de fogo e vai fugir de algumas das balas disparadas contra ela."
