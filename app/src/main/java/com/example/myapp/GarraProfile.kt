...
class GarraProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.skillq.setOnClickListener {
            ...
            binding.skilldescription.text = "Carregue um tiro poderoso que atravessa os inimigos. Segure [1] ou [LMC] para segurar o tiro"
        ...
        binding.skille.setOnClickListener {
            ...
            binding.skilldescription.text = "Lança-o no alto do ar, permitindo-lhe deslizar lentamente. Enquanto no ar, você ganha Dano de Arma e multishot na tua arma. Pressione [SPACE] para cancelar o deslizamento"
            ...
            binding.skillleveldetailtwo.text = "Enquanto no ar, +5 Dano de Arma e dano de arma aplica 40% de movimento lento para 1,5s"
            binding.skillleveldetailthree.text = "Enquanto Airborne, +50% Bullet Lifesteal e +50% Spirit Lifesteal"
        }
        binding.skillc.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Immobilizing Trap"
            binding.skilldescription.text = "Jogue fora uma armadilha isso começa a se armar. Uma vez armada, a armadilha será acionada quando um inimigo entrar em seu raio imobilização eles."
            binding.skillrange.text = "6m Raio "
            binding.skillduration.text = "20s Vida"
            binding.skilltime.text = "37s Recarga "
            binding.skilldetailone.text = "1.25s Imobilizar Duração, seguido por 50% Movimento Lento"
            ...
            binding.skillleveldetailthree.text = "Grey Talon +30% mais Dano de Bala aos inimigos atingidos por Armadilha Imobilizadora durante 10s"
        }
        binding.skillx.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Guided Owl"
            binding.skilldescription.text = "Após o tempo de lançamento de 1,5s, o lance uma coruja espiritual que você controla e que explode no impacto, e prejudicial e impressionante inimigos. Segure [LMC] para acelerar a coruja. Pressione [SPACE] para liberar o controle. Ganho poder Espiritual Permanente para cada inimigo morto com Coruja Guiada"
            ...
            binding.skillleveldetailthree.text = "Depois de atingido, mata os inimigos que estão abaixo de 22% de Vida"
        }
        fun hideSystemUI() {
