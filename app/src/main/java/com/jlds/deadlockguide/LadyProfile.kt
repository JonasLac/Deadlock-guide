    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.skillq.setOnClickListener {
            ...
            binding.skilldescription.text =
                "Sacrifique um pouco da sua saúde para lançar uma bomba que causa dano depois de um breve tempo de braço. O tipo de dano próprio é o Espírito e pode ser mitigado."
            ...
            binding.skillleveldetailthree.text =
                "As bombas deixam uma bagunça tóxica no chão, causando 26% do dano original por segundo, por 6s."
        }
        binding.skille.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Life Drain "
            binding.skilldescription.text =
                "Causa um laço que drena a saúde do inimigo ao longo do tempo e cura-te. O alvo deve estar na linha de visão e dentro do alcance máximo para drenar. Você pode atirar e usar outras habilidades durante o dreno, mas sua velocidade de movimento é reduzida pela metade."
            ...
            binding.skillleveldetailthree.text =
                "O Inimigo é Silenciado enquanto está sendo Drenado pela Vida (requer linha de visão)"
        }
        binding.skillc.setOnClickListener {
            binding.layoutskills.visibility = View.VISIBLE
            binding.skillselect.text = "Malice "
            binding.skilldescription.text =
                "Sacrifique um pouco da sua saúde para lançar fragmentos de sangue que aplicam uma pilha de malícia. Cada pilha retarda a vítima e aumenta o dano eles tiram de você. O efeito lento diminui com o tempo."
        ...
        binding.skillx.setOnClickListener {
            ...
            binding.skilldescription.text =
                "Troca os níveis de saúde com um alvo inimigo. Há uma porcentagem mínima de saúde que os inimigos podem ser reduzidos e uma quantidade mínima de saúde recebida com base na saúde atual das vítimas."
            ...
            binding.skillleveldetailthree.text =
                "No elenco, +40% Taxa de Fogo e +40% Resistência Espiritual para 8s."
        }
    }
}